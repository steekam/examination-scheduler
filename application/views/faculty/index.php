                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="c-u" role="tabpanel">
                        <div class="row">
                                                        ...
                                                        <div class="list-group lg-odd-white">
                                                            <div class="list-group-item media">
                                                                ...
                                                                <div class="media-body" >
                                                                    <div style="white-space:initial;" class="lgi-heading f-17 c-cyan">Unit #1</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="card-header">
                                    <h2 class="c-teal text-uppercase">Configuration</h2>
                                </div>
                                        ...
                                        <form class="js-unit add-action" data-add-action="<?= base_url('faculty/add_unit');?>" data-edit-action="<?= base_url('faculty/edit_unit');?>" method="post">
                                            <div class="row">
                                                <div class="form-group col-md-6 col-xs-6">
                                                    ...
                                                    <div class="fg-line">
                                                        ...
                                                        <input type="hidden" id="check_unit_code" value="<?= base_url('faculty/validate_unit/true/false');?>">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="fg-line">
                                                        ...
                                                        <input type="hidden" id="check_unit_name" value="<?= base_url('faculty/validate_unit/false/true');?>">
                                                        <input type="hidden" id="check_unit_name_edit" value="<?= base_url('faculty/validate_unit_edit');?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6 col-xs-6">
                                                    ...
                                                    <div class="fg-line">
                                                        <input type="text" class="form-control input-mask input-lg" name="exam_duration" data-mask="00:00" placeholder="eg: HH:MIN(01:30)" maxlength="4" autocomplete="off">
